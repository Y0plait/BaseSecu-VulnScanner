...
import machine_processor as mp
import vulnerability_checker as vc
from constants import NVD_NIST_CPE_API_KEY, CACHE_DIR, DEFAULT_INVENTORY, API_REQUEST_DELAY
