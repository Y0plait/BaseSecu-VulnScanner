...
def generate_html_report(output_file=None, machines_config=None):
    """
    Generate comprehensive HTML vulnerability report with network visualizations.
    
    @param output_file str Output HTML file path (default: cache/vulnerability_report.html)
    @param machines_config dict Machine configuration from inventory (for network visualization)
    ...
    - Statistics overview
    - Machine summaries with network topology visualization
